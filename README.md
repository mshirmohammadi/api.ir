...
توضیح: این وب سرویس در مستندات وجود دارد اما در کلاس شما پیاده‌سازی نشده است. با این وب سرویس می توانید نام صاحب یک کارت بانکی را استعلام نمایید.

## 
### 3️⃣2️⃣ سرویس تبدیل کارت به شبا (cardToIban)
...
توضیح: این وب سرویس در مستندات وجود دارد اما در کلاس شما پیاده‌سازی نشده است. با دریافت مختصات نقطه Latitude و Longitude آدرس را بر می گرداند.


## 
### 🔟2️⃣ سرویس استعلام کدپستی (getPostalCodeInfo)
...
توضیح: این وب سرویس در مستندات وجود دارد اما در کلاس شما پیاده‌سازی نشده است. این وب سرویس gpt ورژن 4 است که دسترسی آن برای ایرانیان با محدودیت هایی روبرو شده که از این طریق می توانید از آن استفاده کنید.


## 
### 4️⃣3️⃣ تبدیل متن به صوت با هوش مصنوعی بومی (TextToSpeech) - عدم وجود در کلاس
توضیح: این وب سرویس در مستندات وجود دارد اما در کلاس شما پیاده‌سازی نشده است. تبدیل متن های کوتاه به صوت با هوش مصنوعی بومی که در اینترنت ملی هم کار می کند.


## 
### 5️⃣3️⃣ استعلام سامانه ثنا (checkSana)
...
توضیح: این وب سرویس در مستندات وجود دارد اما در کلاس شما پیاده‌سازی نشده است. با این وب سرویس می توانید اعتبار مجوز شغلی (پروانه کسب) شخصی یا شرکتی را استعلام بگیرید.


## 
### 🔟3️⃣ استعلام تسهیلات فعال بانکی (getActiveLoans)
...
توضیح: این وب سرویس در مستندات وجود دارد اما در کلاس شما پیاده‌سازی نشده است. اطلاعات مربوط به کارت خودرو و سند مالکیت را ارائه می‌دهد.

## 
### 8️⃣4️⃣ استعلام مشخصات و مدل خودرو (getVehicleInfoByParts)
